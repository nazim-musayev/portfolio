...
const About = () => {
  const skills = [ "HTML", "CSS", "SCSS", "JS", "REACT", "NEXT JS", "CONTEXT API", "REDUX", "MATERIAL UI", 
                   "TYPESCRIPT", "FIRESTORE", "FIREBASE AUTH", "CLOUD FUNCTIONS" ];
    ...
    <>
      <Box mb={5} display="flex" flexDirection="column" alignItems="center" justifyContent="center">
        ...
        <Box clone borderRadius="50%" my={6}>
          <img src="profilepic.jpg" width="200" height="200" alt="Profile pic" />
        </Box>
        <Grid container>
          ...
          <Grid item xs={12} sm={10} md={8}>
            ...
            <Typography variant="body2" gutterBottom align="justify">
              I am a self-taught Front-end developer based in Azerbaijan and i have been learning development 
              for 8 months.This is my portfolio website, where you can find my projects, contact information 
              and also a little bit personal information about me.
            </Typography>           
            <Box mt={3}>
                <Divider/>
            </Box>
